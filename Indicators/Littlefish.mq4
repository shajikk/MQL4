...
int OnInit() {
  ...
  SetIndexLabel(0, "3 EMA");
  SetIndexStyle(1, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(1, ExtMapBuffer2);
  SetIndexLabel(1, "5 EMA");
  SetIndexStyle(2, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(2, ExtMapBuffer3);
  SetIndexLabel(2, "8 EMA");
  SetIndexStyle(3, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(3, ExtMapBuffer4);
  SetIndexLabel(3, "10 EMA");
  SetIndexStyle(4, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(4, ExtMapBuffer5);
  SetIndexLabel(4, "12 EMA");
  SetIndexStyle(5, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(5, ExtMapBuffer6);
  SetIndexLabel(5, "15 EMA");

  SetIndexStyle(6, DRAW_LINE, STYLE_SOLID, 1);
  SetIndexBuffer(6, ExtMapBuffer7);
  SetIndexLabel(6, "21 EMA");
...
//---
    ...
    for (int i=0; i<uncounted_bars; i++) {
      ...
      ExtMapBuffer7[i] = iMA(NULL, 0, 21, 0, MODE_EMA, PRICE_CLOSE, i); 
    }
